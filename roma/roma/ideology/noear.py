...
class Nomear(object):
  ...
  # The cloud can be called as Nomear.cloud, so once you create a Nomear
  cloud = OrderedDict()
...
if __name__ == '__main__':
  noear = Nomear()
  noear.put_into_pocket('cloud', 'cloud', local=False)
  noear.put_into_pocket('local', 'local', local=True)
  noear_2 = Nomear()
  noear_2.put_into_pocket('cloud_2', 'cloud_2', local=False)
  noear_2.put_into_pocket('local_2', 'local_2', local=True)
  print(noear._pocket)
  # noear.release()
  print(noear._pocket)
  print(Nomear.cloud)
